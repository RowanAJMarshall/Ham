...
import "github.com/rowanajmarshall/ham/token"

type Lexer struct {
	input        string // Input code string
	position     int    // Points to the ch byte-character
	readPosition int    //
...
func (l *Lexer) NextToken() token.Token {
	...
	default:
		if isLetter(l.ch) {
			...
			return tok
			// TODO add branch for doubles/float
		} else {
...
// Peek ahead without incremeting l.readPosition or l.position
